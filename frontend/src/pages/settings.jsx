        ...
        <main className="flex-1 p-8">
          {loading ? (
            <div className="max-w-5xl space-y-4">
              <div className="h-8 w-40 bg-[#F1EFE8] rounded animate-pulse" />
              <div className="h-40 bg-[#F1EFE8] rounded-2xl animate-pulse" />
            </div>
          ) : error ? (
            ...
            <div className="flex gap-10 max-w-5xl">
              {/* Sticky side nav (settings sections, distinct from the app Sidebar) */}
